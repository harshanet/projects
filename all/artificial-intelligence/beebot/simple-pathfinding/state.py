...
class State:
    ...
    # def is_goal(self, state2):
    #     state1 = self.deepcopy
    ...
    def __str__(self):
        return f'State(BEE_posit={self.BEE_posit}, BEE_orient={self.BEE_orient}, widget_centres={self.widget_centres}, widget_orients={self.widget_orients})'
